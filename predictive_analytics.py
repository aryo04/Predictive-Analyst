...
* `gender`: Jenis kelamin perempuan lebih banyak dibandingkan laki-laki serta terdapat  Other dengan jumlah yang sangat sedikit.
...
"""**Insight** : menghapus data dengan gender Other karena jumlahnya sangat sedikit dan dianggap tidak signifikan untuk analisis."""
